...
describe("Ones", function() {
    it("should score 1", function() {
        assert.equal(1, Yatzy.ones(1,2,3,4,5));
    });

    it("should score 2", function() {
...
describe("Threes", function() {
    it("should score 6", function() {
        assert.equal(6, Yatzy.threes(1,2,3,2,3));
    });

    it("should score 12", function() {
...
describe("Three of a kind", function() {
    ...
    it("should score 9 when four of a kind", function() {
        assert.equal(9, Yatzy.threeOfAKind(3,3,3,3,5));
    });

    it("should score 0 when pair", function() {
...
describe("Four of a kind", function() {
    ...
    it("should score 12 when five of a kind", function() {
        assert.equal(12, Yatzy.fourOfAKind(3,3,3,3,3));
    });

    it("should score 0 when full house", function() {
        assert.equal(0, Yatzy.fourOfAKind(3,3,3,5,5));
    });

    it("should score 0 when three of a kind", function() {
...
describe("Small straight", function() {
    it("should score 15 when ordered", function() {
        assert.equal(15, Yatzy.smallStraight(1,2,3,4,5));
    });

    it("should score 15 when unordered", function() {
...
describe("Large straight", function() {
    it("should score 20 when ordered", function() {
        assert.equal(20, Yatzy.largeStraight(6,2,3,4,5));
    });

    it("should score 20 when unordered", function() {
        assert.equal(20, Yatzy.largeStraight(2,3,4,5,6));
    });

    it("should score 0 when small straight", function() {
...
describe("Full house", function() {
    ...
    it("should score 0 when two pairs", function() {
    ...
    it("should score 0 when four of a kind", function() {
        assert.equal(0, Yatzy.fullHouse(2,2,2,2,6));
    });

    it("should score 0 when five of a kind", function() {
