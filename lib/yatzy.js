...
Yatzy.ones = function (d1, d2, d3, d4, d5) {
    return sumOccurences(1, [d1, d2, d3, d4, d5]);
}

Yatzy.twos = function (d1, d2, d3, d4, d5) {
    return sumOccurences(2, [d1, d2, d3, d4, d5]);
}

Yatzy.threes = function (d1, d2, d3, d4, d5) {
    return sumOccurences(3, [d1, d2, d3, d4, d5]);
}

Yatzy.fours = function (d1, d2, d3, d4, d5) {
    return sumOccurences(4, [d1, d2, d3, d4, d5]);
}

Yatzy.fives = function (d1, d2, d3, d4, d5) {
    return sumOccurences(5, [d1, d2, d3, d4, d5]);
}

Yatzy.sixes = function (d1, d2, d3, d4, d5) {
    return sumOccurences(6, [d1, d2, d3, d4, d5]);
}
...
function sumOccurences(targetValue, array) {
    return array
...
function sumOfAKind(valueOfAKind, strictComparison, d1, d2, d3, d4, d5) {
    ...
    for (const duplicateDice of duplicateDices) {
        const occurencesDuplicateDice = countOccurences(duplicateDice, dices);
