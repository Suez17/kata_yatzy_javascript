...
Yatzy.twoPairs = function (d1, d2, d3, d4, d5) {
    ...
    if (duplicateDices.size == 2) {
        sumOfTwoPairs = findSumOfAllOccurences(duplicateDices, [d1, d2, d3, d4, d5], 2, false);
    }
...
Yatzy.threeOfAKind = function (d1, d2, d3, d4, d5) {
    const duplicateDices = findDuplicateDices(d1, d2, d3, d4, d5);
    return findSumOfAllOccurences(duplicateDices, [d1, d2, d3, d4, d5], 3, false);
}

Yatzy.fourOfAKind = function (d1, d2, d3, d4, d5) {
    const duplicateDices = findDuplicateDices(d1, d2, d3, d4, d5);
    return findSumOfAllOccurences(duplicateDices, [d1, d2, d3, d4, d5], 4, false);
}
